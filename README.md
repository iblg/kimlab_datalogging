...
## How to install `kimlab_datalogging` locally

`cd` into the project directory:

```bash
cd kimlab_datalogging
```

Create and activate a new conda environment:

```bash
conda create -n kimlab_datalogging_env python=<max_python_version>
conda activate kimlab_datalogging_env
```
